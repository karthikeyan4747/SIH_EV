...
async function request<T>(
  ...
  try {
    ...
    throw new Error(
      'Network unavailable. Check that the backend is running.',
    )
  }
  ...
  if (!response.ok) {
    ...
    try {
      ...
      // Keep generic error for non-JSON responses.
    }
...
export function createTextSource(
  ...
  return request<SourceCreatedResponse>(
    '/api/v1/sources/text',
    {
      method: 'POST',
      body: JSON.stringify({
...
export function patchContentDNA(
  sourceId: string,
  changes: ContentDNAPatch,
) {
  return request<ContentDNA>(
    `/api/v1/sources/${sourceId}/content-dna`,
    {
      method: 'PATCH',
...
export function renameTransformation(
  transformationId: string,
  title: string,
) {
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/title`,
    {
      method: 'PATCH',
      body: JSON.stringify({ title }),
    },
...
export function addTextSource(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/sources/text`,
    {
      method: 'POST',
      body: JSON.stringify({
        title,
...
export function addFileSource(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/sources/file`,
    {
      method: 'POST',
      headers: {},
      body,
...
export function addUrlSource(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/sources/url`,
    {
      method: 'POST',
      body: JSON.stringify({
        url,
...
export function addUnsupportedSource(
  transformationId: string,
  source_type: string,
  title: string,
  note = '',
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/sources/unsupported`,
    {
      method: 'POST',
      body: JSON.stringify({
        source_type,
...
export function removeTransformationSource(
  transformationId: string,
  sourceId: string,
) {
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/sources/${sourceId}`,
    {
      method: 'DELETE',
    },
  )
...
export function patchTransformationDNA(
  transformationId: string,
  changes: ContentDNAPatch,
) {
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/content-dna`,
    {
      method: 'PATCH',
      body: JSON.stringify(changes),
    },
...
export function createTransformationStructure(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/structures`,
    {
      method: 'POST',
...
export function createReferenceStructure(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/structures/reference`,
    {
      method: 'POST',
      body: JSON.stringify(payload),
    },
...
export function restoreTransformationVersion(
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/versions/${version}/restore`,
    {
      method: 'POST',
    },
  )
...
export function resolveTransformationConflict(
  transformationId: string,
  conflictId: string,
  resolution: Omit<
  ...
  return request<Transformation>(
    `/api/v1/transformations/${transformationId}/integrity/conflicts/${conflictId}/resolve`,
    {
      method: 'POST',
      body: JSON.stringify({
...
export function listWorkflows() {
  return request<WorkflowTemplate[]>(
    '/api/v1/transformations/workflows',
  )
}
